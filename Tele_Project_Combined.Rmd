...
### We are using a 70% split for our training set in order to increase the speed of the computing.
```{r}
# 70 - 30 split
set.seed(12345)
...
### The output of the stepwise function with a backwwards direction was manually taken and and recorded below for computing efficiency. 
```{r}
# the below line is commented because it is too taxing to run at the moment for testing.
